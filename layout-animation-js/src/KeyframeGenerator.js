...
const BezierEasing = require("./bezierEasing");
...
export const generateKeyframes = (
  ...
  if (ease && ease !== "spring") {
    const easingFunction = staticEasingFunctions[ease];
    return generateStaticKeyframes(easingFunction, duration, resolvedDelay);
  }
